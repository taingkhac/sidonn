      ...
      <section className="bg-secondary py-6">
        <div className="container mx-auto px-4">
          ...
          <div className="flex items-center gap-2 text-sm text-muted-foreground">
            ...
            <span>/</span>
            <span className="text-foreground">{translate('breadcrumb_contact', lang, 'Contact Us')}</span>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 sm:py-16 md:py-20 bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 text-white">
        <div className="container mx-auto px-4 sm:px-6 text-center">
          ...
          <p className="text-base sm:text-lg md:text-xl text-slate-300 max-w-2xl mx-auto">
            {translate('contact_subtitle', lang, "Let's discuss how our automation solutions can transform your business operations")}
          </p>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4 sm:px-6">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 md:gap-12 max-w-6xl mx-auto">
            ...
            <div className="space-y-8">
              <div>
                <h2 className="text-2xl font-bold mb-6">{translate('contact_info_title', lang, 'Contact Information')}</h2>
                <p className="text-muted-foreground leading-relaxed mb-8">
                  {translate('contact_info_desc', lang, 'Reach out to our team for inquiries, support, or to schedule a consultation.')}
                </p>
              </div>
              ...
              <div className="space-y-6">
                <div className="flex gap-4">
                  ...
                  <div>
                    <h3 className="font-semibold mb-1">{translate('contact_email_label', lang, 'Email')}</h3>
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    <h3 className="font-semibold mb-1">{translate('contact_phone_label', lang, 'Phone')}</h3>
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    <h3 className="font-semibold mb-1">{translate('contact_address_label', lang, 'Headquarters')}</h3>
              ...
              <div className="bg-white border border-border p-8 relative overflow-hidden">
                {isSuccess ? (
                  <div className="py-20 text-center animate-in fade-in zoom-in duration-500">
                    ...
                    <h2 className="text-3xl font-bold text-slate-900 mb-4">{translate('contact_success_title', lang, 'Message Sent!')}</h2>
                    <p className="text-slate-600 mb-8 max-w-sm mx-auto">
                      {translate('contact_success_desc', lang, 'Thank you for contacting us. Our team has received your inquiry and will get back to you shortly.')}
                    </p>
                    <button
                  ...
                  <>
                    <h2 className="text-2xl font-bold mb-6">{translate('contact_form_title', lang, 'Send us a Message')}</h2>
                    <form onSubmit={handleSubmit} className="space-y-6">
                      ...
                      >
                        ...
                        {loading ? translate('btn_sending', lang, 'Sending...') : translate('btn_send_message', lang, 'Send Message')}
                      </button>
                    </form>
                  </>
                )}
