...
export function HomePage({ onNavigate }: HomePageProps) {
  ...
  const heroSubtitle = translate('hero_subtitle', lang, 'Industry-leading warehouse automation solutions that drive efficiency')
  const heroVideoUrl = translate('hero_video', lang)

  return (
    <main className="flex-1">
      {/* Hero Section */}
      <section className="relative min-h-[500px] h-[600px] lg:h-[700px] flex items-center justify-center overflow-hidden">
        {/* Background Layer */}
        {heroVideoUrl ? (
        ...
        <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h1 
            className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold text-white mb-6 sm:mb-8 tracking-tight"
            dangerouslySetInnerHTML={{ __html: heroTitle }}
          />
          <div 
            className="text-lg sm:text-xl md:text-2xl text-slate-200 mb-10 max-w-3xl mx-auto prose prose-invert"
            dangerouslySetInnerHTML={{ __html: heroSubtitle }}
          />
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <button 
              onClick={() => onNavigate('solutions-overview')}
              className="px-8 py-4 bg-primary text-primary-foreground font-semibold hover:bg-primary/90 transition-all inline-flex items-center justify-center gap-2 group"
            >
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto leading-relaxed">
              {translate('solutions_subtitle', lang, 'Six pillars of innovation powering the future of logistics automation')}
            </p>
          </div>
      ...
      <section className="py-24 bg-secondary">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto leading-relaxed">
              {translate('global_subtitle', lang, 'Trusted by leading enterprises across the world')}
            </p>
          </div>
