        ...
        <div className="container mx-auto px-4 sm:px-6">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-base sm:text-lg md:text-xl text-muted-foreground leading-relaxed">
              {translate('newsroom_subtitle', lang, 'Latest news, press releases, and media resources')}
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4 sm:px-6">
          <div className="max-w-4xl mx-auto space-y-6">
            {newsList.map((news, index) => (
              <div key={index} className="p-4 sm:p-6 border border-border hover:border-primary transition-colors">
      ...
      <section className="py-12 sm:py-16 md:py-20 bg-secondary">
        <div className="container mx-auto px-4 sm:px-6">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-base sm:text-lg md:text-xl text-muted-foreground leading-relaxed">
              {translate('support_subtitle', lang, "We're here to help with your automation needs 24/7")}
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4 sm:px-6">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8 max-w-5xl mx-auto">
            <div className="p-6 border border-border text-center hover:border-primary transition-colors">
              ...
              <h3 className="text-xl font-semibold mb-3">{translate('support_phone_title', lang, 'Phone Support')}</h3>
              <p className="text-muted-foreground mb-4">{translate('support_phone_desc', lang, 'Available 24/7')}</p>
              <a href="tel:+18005551234" className="text-primary font-semibold hover:text-primary/80">
                +1 (800) 555-1234
              </a>
            </div>
            <div className="p-6 border border-border text-center hover:border-primary transition-colors">
              <Mail className="h-12 w-12 mx-auto mb-4 text-primary" />
              <h3 className="text-xl font-semibold mb-3">{translate('support_email_title', lang, 'Email Support')}</h3>
              <p className="text-muted-foreground mb-4">{translate('support_email_desc', lang, 'Response within 24 hours')}</p>
              <a href="mailto:support@gla.com" className="text-primary font-semibold hover:text-primary/80">
                support@gla.com
              </a>
            </div>
            <div className="p-6 border border-border text-center hover:border-primary transition-colors">
              <MessageSquare className="h-12 w-12 mx-auto mb-4 text-primary" />
              <h3 className="text-xl font-semibold mb-3">{translate('support_chat_title', lang, 'Live Chat')}</h3>
              <p className="text-muted-foreground mb-4">{translate('support_chat_desc', lang, 'Chat with our team')}</p>
          ...
          <div className="max-w-4xl mx-auto mt-16">
            <h2 className="text-3xl font-bold mb-8 text-center">{translate('support_faq_title', lang, 'Frequently Asked Questions')}</h2>
            <div className="space-y-6">
              {[
                ...
                <div key={index} className="p-6 bg-secondary">
                  <h3 className="text-lg font-semibold mb-2">{translate(`${faq.key}_q`, lang, faq.q)}</h3>
      ...
      <section className="py-12 sm:py-16 md:py-20">
        <div className="container mx-auto px-4 sm:px-6">
          <div 
            ...
            dangerouslySetInnerHTML={{ __html: translate('privacy_content', lang, `
              <div class="space-y-8">
                <div>
    ...
    <main className="flex-1">
      ...
      <section className="py-12 sm:py-16 md:py-20">
        <div className="container mx-auto px-4 sm:px-6">
          <div 
            className="max-w-4xl mx-auto prose prose-slate"
            dangerouslySetInnerHTML={{ __html: translate('terms_content', lang, `
              <div class="space-y-8">
                <div>
