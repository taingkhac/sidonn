import { Monitor, Database, BarChart3, Shield } from 'lucide-react'
...
export function SoftwarePage({ onNavigate, softwareType }: SoftwarePageProps) {
  ...
  const software = {
    ...
    subtitle: translate(`software_${softwareType}_subtitle`, lang, 'Smart logistics software solutions'),
    description: translate(`software_${softwareType}_description`, lang, 'Enterprise-grade software for complete visibility and control.'),
    capabilities: [
      {
        icon: Monitor,
        title: translate(`software_${softwareType}_cap_1_title`, lang, 'Real-Time Monitoring'),
        description: translate(`software_${softwareType}_cap_1_desc`, lang, 'Track inventory and resources in real-time'),
      },
      {
        icon: Database,
        title: translate(`software_${softwareType}_cap_2_title`, lang, 'Data Management'),
        description: translate(`software_${softwareType}_cap_2_desc`, lang, 'Centralized management of supply chain data'),
      },
      {
        icon: BarChart3,
        title: translate(`software_${softwareType}_cap_3_title`, lang, 'Analytics'),
        description: translate(`software_${softwareType}_cap_3_desc`, lang, 'KPI tracking and data-driven decisions'),
      },
      {
        icon: Shield,
        title: translate(`software_${softwareType}_cap_4_title`, lang, 'Security'),
        description: translate(`software_${softwareType}_cap_4_desc`, lang, 'Enterprise-grade security and compliance'),
      },
    ],
    benefits: [
      ...
      <section className="py-24 bg-secondary">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center">
            <h1 className="text-5xl font-bold mb-6">{software.title}</h1>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto">
            {software.capabilities.map((capability, index) => {
              ...
              return (
                <div key={index} className="p-6 border border-border hover:border-primary transition-colors">
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {software.benefits.map((benefit, index) => (
                <div key={index} className="flex items-center gap-3 p-4 bg-white border border-border">
