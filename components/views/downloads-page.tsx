        ...
        <section className="bg-secondary py-12">
          <div className="container mx-auto px-4">
            <div className="flex items-center gap-2 text-sm text-muted-foreground mb-4">
              <span>{translate('breadcrumb_home', lang, 'Home')}</span>
              <span>/</span>
              <span>{translate('breadcrumb_company', lang, 'Company')}</span>
              <span>/</span>
              <span className="text-foreground">{translate('breadcrumb_downloads', lang, 'Downloads')}</span>
            </div>
        ...
        <div className="sticky top-0 z-40 bg-white border-b border-border shadow-sm">
          <div className="container mx-auto px-4 py-6">
            ...
            <div className="relative mb-6">
              ...
              <Input
                type="text"
                placeholder={translate('downloads_search_placeholder', lang, 'Search for manuals, brochures...')}
                value={searchQuery}
            ...
            {paginatedResources.length === 0 ? (
              <div className="text-center py-16">
                <p className="text-xl text-muted-foreground">
                  {translate('downloads_no_results', lang, 'No resources found matching your criteria.')}
                </p>
              </div>
            ) : (
