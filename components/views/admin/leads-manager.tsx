    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-muted-foreground text-sm">Xem và quản lý thông tin khách hàng để lại từ website.</p>
        </div>
        <Button onClick={fetchLeads} variant="outline" size="sm">Làm mới</Button>
      </div>
