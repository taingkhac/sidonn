...
export function ProductPage({ onNavigate, productType }: ProductPageProps) {
  ...
  const product = {
    ...
    subtitle: translate(
      `product_${productType}_subtitle`,
      lang,
      'Premium material handling solutions',
    ),
    description: translate(
      `product_${productType}_description`,
      lang,
      'Our advanced systems are designed to optimize space utilization while ensuring safety and accessibility.',
    ),
    features: [
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="bg-white border border-border p-8">
              <p className="text-center text-muted-foreground">
                For detailed technical specifications and custom configurations, please contact our
                sales team.
              </p>
