                ...
                >
                  <div>
                    <div className="font-medium text-slate-900">
                      {item.translations?.['en'] || item.key}
                    </div>
                    <div className="text-sm text-slate-500">
                      Key: {item.key} | Tiếng Việt: {item.translations?.['vi']} | View:{' '}
                      {item.view_target || '(Danh mục)'}
                    </div>
                  </div>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      setEditingMenu({ ...editingMenu, view_target: e.target.value })
                    }
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      setEditingMenu({ ...editingMenu, order_index: parseInt(e.target.value) || 0 })
                    }
                  />
                </div>
              </div>
                ...
                <div className="space-y-3">
                  {LANGUAGES.map((lang) => (
                    <div key={lang} className="grid grid-cols-4 items-center gap-4">
                      <Label className="text-right uppercase font-bold text-slate-500">
                        {lang}
                      </Label>
                      <Input
