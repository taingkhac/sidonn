          ...
          <div className="max-w-5xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
              {solution.features.map((feature, index) => (
                <div
                  key={index}
                  className="flex gap-4 p-6 border border-border hover:border-primary transition-colors"
                >
          ...
          <div className="max-w-5xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              {solution.applications.map((application, index) => (
                <div
                  key={index}
                  className="p-6 bg-secondary border border-border text-center hover:border-primary transition-colors"
                >
        ...
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl text-slate-300 mb-8 max-w-2xl mx-auto">
            {translate(
              'cta_ready_subtitle',
              lang,
              `Contact our team to discuss how ${solution.title} can transform your operations.`,
            )}
          </p>
          <button
