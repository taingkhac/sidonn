  ...
  const stats = [
    {
      icon: Globe2,
      value: '50+',
      label: translate('about_stats_label_1', lang, 'Countries Worldwide'),
    },
    {
      icon: Building2,
      value: '10,000+',
      label: translate('about_stats_label_2', lang, 'Projects Delivered'),
    },
    { icon: Users, value: '5,000+', label: translate('about_stats_label_3', lang, 'Team Members') },
    {
      icon: Award,
      value: '35+',
      label: translate('about_stats_label_4', lang, 'Years of Excellence'),
    },
  ]
      ...
      <section className="py-12 sm:py-16 md:py-20">
        <div className="container mx-auto px-4 sm:px-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 max-w-5xl mx-auto">
            ...
            <div>
              <h2 className="text-3xl font-bold mb-4">
                {translate('about_vision_title', lang, 'Our Vision')}
              </h2>
              <p className="text-muted-foreground leading-relaxed">
                {translate(
                  'about_vision_desc',
      ...
      <section className="py-20 bg-slate-900 text-white">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-4xl font-bold mb-4">
            {translate('about_cta_title', lang, 'Ready to Transform Your Operations?')}
          </h2>
          <p className="text-xl text-slate-300 mb-8 max-w-2xl mx-auto">
            {translate(
              'about_cta_subtitle',
              lang,
              'Join thousands of companies worldwide who trust us for their automation needs',
            )}
          </p>
          <button
