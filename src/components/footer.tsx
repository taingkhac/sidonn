        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              <li>
                <button
                  onClick={() => onNavigate?.('smart-warehouse')}
              ...
              <li>
                <button
                  onClick={() => onNavigate?.('seaport-agv')}
                  className="text-slate-400 hover:text-primary transition-colors text-left"
                >
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              <li>
                <button
                  onClick={() => onNavigate?.('product-racking')}
                  className="text-slate-400 hover:text-primary transition-colors text-left"
                >
              ...
              <li>
                <button
                  onClick={() => onNavigate?.('product-containers')}
                  className="text-slate-400 hover:text-primary transition-colors text-left"
                >
              ...
              <li>
                <button
                  onClick={() => onNavigate?.('product-conveyors')}
                  className="text-slate-400 hover:text-primary transition-colors text-left"
                >
              ...
              <li>
                <button
                  onClick={() => onNavigate?.('product-robotics')}
                  className="text-slate-400 hover:text-primary transition-colors text-left"
                >
              ...
              <li>
                <button
                  onClick={() => onNavigate?.('software-wamas')}
                  className="text-slate-400 hover:text-primary transition-colors text-left"
                >
              ...
              <li>
                <button
                  onClick={() => onNavigate?.('software-sap')}
                  className="text-slate-400 hover:text-primary transition-colors text-left"
                >
          ...
          <div>
            ...
            <div className="mt-6 pt-6 border-t border-slate-800">
              <h4 className="text-white font-semibold mb-3 text-sm">
                {translate('label_legal', lang, 'Legal')}
              </h4>
        ...
        <div className="container mx-auto px-4 py-6">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            <p className="text-sm text-slate-400">
              © {new Date().getFullYear()} Sidonn.{' '}
              {translate('label_all_rights', lang, 'All rights reserved.')}
            </p>
          </div>
        </div>
      </div>
